...
class PurchaseOrder(models.Model):
    ...
    date = fields.Date("Order Deadline")
...
class PurchaseOrderLine(models.Model):
    ...
    #             'price_subtotal': taxes['total_excluded'],
    #         })
    # Usman's Custoization Starts from here.
    # price_sub_total
    ...
    @api.depends('mon', 'product_qty', 'price_unit')
    def _compute_without(self):
        for record in self:
            record.total_without = record.product_qty * record.price_unit / record.mon
...
#usman
    def _prepare_account_move_line(self, move=False):
        ...
        res = {
            ...
            'carton_rate': self.carton_rate,
            'carton_value': self.carton_value,
            'total_without': self.total_without,
            'total_weight': self.price_unit,
